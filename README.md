...
Use SQL to transform, aggregate, and filter the dataset

Build a data model in Power BI

Visualize global COVID-19 trends with interactive charts
...
SQL – queries for transformation and preprocessing
...
Date-wise COVID-19 cases

Confirmed, recovered, and deceased counts
...
Trend Line Charts: Daily & monthly case progression

Country Comparison Table

Map Visualization showing global spread
